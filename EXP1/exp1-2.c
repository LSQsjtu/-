...
int main(void)
{
	uint32_t delay_time, key_value,key;
	...
	while(1)
  {
		...
		key = GPIOPinRead(GPIO_PORTJ_BASE,GPIO_PIN_1)	;				//read the PJ0 key value

		if (key	== 0)						//USR_SW1-PJ0 pressed
		{
...
void S800_GPIO_Init(void)
{
  ...
  GPIOPinTypeGPIOOutput(GPIO_PORTF_BASE, GPIO_PIN_0);			//Set PF0 as Output pin
	...
	GPIOPinTypeGPIOOutput(GPIO_PORTF_BASE, GPIO_PIN_1);			//Set PF0 as Output pin
